test_that("deprecated session tools emit deprecation warnings", {
  ...
  expect_warning(
    btw_tool_session_package_info(packages = "lazybtw"),
    class = "lifecycle_warning_deprecated"
  )

  expect_warning(
    btw_tool_session_check_package_installed(package_name = "lazybtw"),
    class = "lifecycle_warning_deprecated"
  )
})
...
test_that("deprecated search tools emit deprecation warnings", {
  ...
  expect_warning(
    btw_tool_search_package_info(package_name = "shiny"),
    class = "lifecycle_warning_deprecated"
  )
})
...
test_that("new sessioninfo tools work without warnings", {
  ...
  expect_no_warning(btw_tool_sessioninfo_package(packages = "lazybtw"))
  expect_no_warning(btw_tool_sessioninfo_is_package_installed(
    package_name = "lazybtw"
  ))
})
...
test_that("new cran tools work without warnings", {
  ...
  expect_no_warning(btw_tool_cran_package(package_name = "shiny"))
})
