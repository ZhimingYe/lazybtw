...
btw_app_html_dep <- function() {
  htmltools::htmlDependency(
    name = "btw",
    version = utils::packageVersion("lazybtw"),
    package = "lazybtw",
    src = "js/app",
    script = list(
...
btw_app_from_client <- function(
  ...
  path_figures_installed <- system.file("help", "figures", package = "lazybtw")
  path_figures_dev <- system.file("man", "figures", package = "lazybtw")
